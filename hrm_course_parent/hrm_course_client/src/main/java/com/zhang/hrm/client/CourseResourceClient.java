...
@RequestMapping("/kkk/courseResource")
public interface CourseResourceClient {
     ...
     */
    @PutMapping
    AjaxResult addOrEdit(CourseResource courseResource);
    ...
    //通过id获取用户
    @GetMapping(value = "{id}")
        CourseResource get(@PathVariable("id") Long id);
     ...
     */
    @PostMapping
    PageList<CourseResource> json(@RequestBody CourseResourceQuery query);
}
